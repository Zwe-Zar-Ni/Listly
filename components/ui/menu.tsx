...
const menuStyle = tva({
  base: 'rounded-md p-1 shadow bg-[#ffffff] dark:bg-[#0f172a]',
});

const menuItemStyle = tva({
  base: 'min-w-[200px] p-3 data-[active=true]:opacity-60 flex-row items-center rounded data-[focus=true]:web:outline-none data-[focus=true]:web:outline-0 data-[disabled=true]:opacity-40 data-[disabled=true]:web:cursor-not-allowed data-[focus-visible=true]:web:outline-2 data-[focus-visible=true]:web:outline-primary-700 data-[focus-visible=true]:web:outline data-[focus-visible=true]:web:cursor-pointer data-[disabled=true]:data-[focus=true]:bg-transparent',
});
